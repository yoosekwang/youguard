                    ...
                    <div class="p-6">
                        <div class="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div class="text-center md:text-left">
                                ...
                                <p class="text-sm text-gray-400 mt-1">{{ developerData.title || 'System Developer' }}
                                </p>
...
const handleAvatarUpload = async (event) => {
    ...
    try {
        ...
        const response = await axios.post(`${useRuntimeConfig().public.apiBase}/api/softwares/new/api/developer/avatar`, formData, {
            headers: {
        ...
        developerData.value.avatar = response.data.avatarUrl
...
const handleProfileUpdate = async () => {
    try {
        ...
        await axios.put(`${useRuntimeConfig().public.apiBase}/api/developer/change-name`,
...
const handlePasswordChange = async () => {
    ...
    try {
        ...
        await axios.put(`${useRuntimeConfig().public.apiBase}/api/developer/change-password`,
            {
...
const fetchUserDetails = async () => {
    try {
        ...
        const response = await axios.get(`${useRuntimeConfig().public.apiBase}/api/developer/details`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
        ...
        profileForm.value = {
            ...
            phone: response.data.developerInfo.phone || '',
            title: response.data.developerInfo.title || '',
            bio: response.data.developerInfo.bio || ''
        }
    } catch (err) {
        console.error(err)
